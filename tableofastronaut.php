...
<html>
 ...
 font-family:helvetica;
	...
	?>
		...
		<table>
			<tr>
				<th width="500px">ASTRONAUT_ID<br><hr></th>
				<th width="500px">ASTRONAUT_NAME<br><hr></th>
				<th width="500px">NO_OF_MISSION<br><hr></th>
			</tr>
					
	<?php
		$sql = mysqli_query($link, "SELECT ASTRONAUT_ID,ASTRONAUT_NAME,NO_OF_MISSION FROM astronaut");
